/*
  # GLP-1 Patient Tracking System - Complete Schema

  ## Overview
  Complete database schema for GLP-1 patient tracking PWA with three user roles:
  Patient, Doctor, and Admin.

  ## New Tables
  1. profiles - Core user profile table
  2. doctors - Doctor-specific information
  3. patients - Patient baseline and profile information
  4. therapy_entries - Medication and dosage tracking
  5. weight_vitals - Weight and vital signs tracking
  6. side_effects - Side effect reporting
  7. adherence_tracking - Medication adherence tracking
  8. weekly_entries - Complete weekly data submission
  9. points_transactions - Gamification points tracking
  10. rewards - Available rewards catalog
  11. patient_rewards - Redeemed rewards
  12. alerts - Safety and monitoring alerts
  13. doctor_notes - Doctor notes on patients
